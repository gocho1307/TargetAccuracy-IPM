...
function setup() {
  ...
  groups = {
    0: new Group([255, 235, 197, 100]),
    A: new Group([199, 55, 47, 100]),
    B: new Group([247, 209, 95, 100]),
    C: new Group([142, 91, 54, 100]),
    F: new Group([255, 202, 77, 100]),
    G: new Group([246, 157, 157, 100]),
    K: new Group([107, 62, 82, 100]),
    L: new Group([240, 164, 132, 100]),
    M: new Group([209, 226, 49, 100]),
    N: new Group([254, 234, 99, 100]),
    O: new Group([107, 61, 104, 100]),
    P: new Group([102, 12, 33, 100]),
    R: new Group([242, 121, 0, 100]),
    S: new Group([229, 232, 150, 100]),
    T: new Group([253, 255, 245, 100]),
    V: new Group([255, 235, 197, 100]),
    W: new Group([255, 235, 197, 100]),
    Y: new Group([255, 247, 215, 100]),
    Z: new Group([253, 255, 245, 100]),
  };
